...
class ProducersControllerTest < ActionController::TestCase
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post :create, producer: { extra: @producer.extra, fax: @producer.fax, location: @producer.location, phone: @producer.phone, profile_url: @producer.profile_url, title: @producer.title, website: @producer.website }
    end
  ...
  test "should update producer" do
    patch :update, id: @producer, producer: { extra: @producer.extra, fax: @producer.fax, location: @producer.location, phone: @producer.phone, profile_url: @producer.profile_url, title: @producer.title, website: @producer.website }
    assert_redirected_to producer_path(assigns(:producer))
  end
